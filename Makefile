...
.PHONY: helm-install
helm-install:
	helm upgrade --install --create-namespace kube-operator deploy/helm -n jihulab-runner

.PHONY: helm-uninstall
helm-uninstall:
	helm uninstall kube-operator -n jihulab-runner

.PHONY: helm-test
helm-test:
	helm test kube-operator -n jihulab-runner --logs
